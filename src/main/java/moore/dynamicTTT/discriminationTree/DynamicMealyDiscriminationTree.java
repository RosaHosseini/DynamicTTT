...
import moore.TTT.discriminiationTree.*;
...
public class DynamicMealyDiscriminationTree<I> extends MooreDiscriminationTree<I> {
    private final Alphabet<I> alphabet;

    public DynamicMealyDiscriminationTree(MealyMembershipCounter<I> membershipCounter, Alphabet<I> alphabet) {
     ...
     */
    public void initialDiscriminationTree(MooreDiscriminationTree<I> outdatedDiscriminationTree) throws Exception {
     ...
     */
    private MealyDiscriminationNode<I> copy(DiscriminatorNode<I> parent, MealyDiscriminationNode<I> DTNode) throws Exception {
