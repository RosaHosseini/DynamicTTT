...
public class OutdatedSpanningTreeContainer<I> {
    ...
    public OutdatedSpanningTreeContainer(SpanningTree<I,Boolean> spanningTree,
                                         Alphabet<I> alphabet,
        ...
        List<TTTNode<I, Boolean>> spanningNodes = spanningTree.getAllStates();
        for (TTTNode<I, Boolean> tttNode : spanningNodes) {
