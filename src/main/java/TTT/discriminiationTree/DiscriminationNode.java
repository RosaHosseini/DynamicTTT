...
public abstract class DiscriminationNode<I> {
    public DiscriminatorNode<I> parent;

    public DiscriminationNode(DiscriminatorNode<I> parent) {
        this.parent = parent;
    }
     ...
     **/
    public abstract DTLeaf<I> sift(Word<I> sequenceAccess, MembershipCounter<I> membershipCounter);
     ...
     */
    abstract protected boolean assertDiscriminator(
     ...
     */
    public abstract @Nullable DTLeaf<I> find(Word<I> word);
}
