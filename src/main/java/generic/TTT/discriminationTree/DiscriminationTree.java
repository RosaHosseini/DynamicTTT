...
public abstract class DiscriminationTree<I, O> {
     ...
     * @return the discriminator of LCA
     */
    protected abstract @Nullable DiscriminationNode<I, O> findLCA(DiscriminationNode<I, O> node, Word<I> word1, Word<I> word2);
