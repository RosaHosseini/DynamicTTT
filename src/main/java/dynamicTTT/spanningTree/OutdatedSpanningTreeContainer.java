...
public class OutdatedSpanningTreeContainer<I> {
    ...
    public OutdatedSpanningTreeContainer(SpanningTree<I> spanningTree,
                                         Alphabet<I> alphabet,
        ...
        List<TTTNode<I>> spanningNodes = spanningTree.getAllStates();
        for (TTTNode<I> tttNode : spanningNodes) {
